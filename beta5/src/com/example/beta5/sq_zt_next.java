...
public class sq_zt_next extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dy_image);
		 ...
		 for(int i=0;i<getre.re2.ima1.size();i++){
		    	if(string.equals(getre.re2.ima1.get(i)))
		    	index=i;
         ...
         t1.setText(getre.re2.text1.get(index));
         t2.setText(getre.re2.text2.get(index));
         t3.setText(getre.re2.text3.get(index));
         t5.setText(getre.re2.text5.get(index));
        ...
        BaseAdapter ba=new BaseAdapter() {
			...
			public View getView(int arg0, View arg1, ViewGroup arg2) {
				...
				View view = View.inflate(sq_zt_next.this, R.layout.tiezilist, null);   	
			    ...
			    i1.setImageDrawable(getResources().getDrawable(getResources().getIdentifier(getre.re2.tz.get(index).get(arg0).image,"drawable", getPackageName())));
				t1.setText(getre.re2.tz.get(index).get(arg0).person+":");
				t2.setText(getre.re2.tz.get(index).get(arg0).text);
         ...
         iv.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent inten=new Intent();
			      ...
			      inten.setClass(sq_zt_next.this, GalleryActivity.class);
			      startActivity(inten);
    ...
    public void end(View v) {     //标题栏 返回按钮
    	finish();
      }    
}
